...
<body>
    ...
    <script>
        ...
        async function loadSubjects() {
            ...
            const response = await fetch(`../php/api/admin/get_subjects.php?${params}`);
        ...
        async function loadSpecialties() {
            ...
            const response = await fetch(`../php/api/admin/get_specialties.php?${params}`);
            const data = await response.json();
        ...
        async function loadFilters() {
            ...
            if (courseNames.length > 0) {
                ...
                const fallback = await fetch('../php/api/admin/get_subjects.php');
            ...
            const response = await fetch('../php/api/admin/get_subjects.php');
            const data = await response.json();
            if (data.success) {
            ...
            // Load teachers
            const teacherResp = await fetch('../php/api/admin/get_users.php?role=teacher');
        ...
        async function saveSubject(e) {
            ...
            const response = await fetch('../php/api/admin/save_subject.php', {
                method: 'POST',
        ...
        async function deleteSubject(id, code) {
            ...
            const response = await fetch('../php/api/admin/delete_subject.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
        ...
        async function saveSpecialty(e) {
            ...
            const response = await fetch('../php/api/admin/save_specialty.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
                body: JSON.stringify(data)
            });
        ...
        async function deleteSpecialty(id, teacher, subject) {
            ...
            const response = await fetch('../php/api/admin/delete_specialty.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
