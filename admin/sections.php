...
async function loadSections() {
    ...
    const res  = await fetch(`../php/api/admin/get_sections.php?${params}`);
...
async function loadFilters() {
    ...
    try {
        const cr = await fetch('../php/api/admin/get_courses.php');
        ...
        if (cd.success && cd.courses.length > 0) {
            ...
            const sr = await fetch('../php/api/admin/get_subjects.php');
    ...
    // Load teachers
    const tr = await fetch('../php/api/admin/get_users.php?role=teacher');
...
async function saveSection(e) {
    ...
    const res  = await fetch('../php/api/admin/save_section.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify(payload) });
    const data = await res.json();
...
async function deleteSection(id, code) {
    ...
    const res  = await fetch('../php/api/admin/delete_section.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({section_id:id}) });
    const data = await res.json();
...
async function loadSectionSubjects() {
    ...
    const res  = await fetch(`../php/api/admin/get_section_subjects.php?section_id=${currentSectionId}`);
    const data = await res.json();
...
async function removeSubjectFromSection(id, name) {
    ...
    const res  = await fetch('../php/api/admin/remove_section_subject.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({section_subject_id:id}) });
    const data = await res.json();
...
async function refreshAssignSubjectList() {
    ...
    try {
        ...
        const [specRes, allRes] = await Promise.all([
            fetch(`../php/api/admin/get_subjects.php?${specificParams}`),
            fetch(`../php/api/admin/get_subjects.php?${allCoursesParams}`)
        ]);
...
async function saveAssignedSubject(e) {
    ...
    const res  = await fetch('../php/api/admin/save_section_subject.php', {
...
async function loadSectionSchedules() {
    if (!currentSectionId) return;
    const res  = await fetch(`../php/api/admin/get_section_schedules.php?section_id=${currentSectionId}`);
    const data = await res.json();
...
async function loadBuildingsAndRooms() {
    // Load buildings
    try {
        const bRes  = await fetch('../php/api/admin/get_buildings.php');
    ...
    // Load all rooms
    try {
        const rRes  = await fetch('../php/api/admin/get_rooms.php');
...
async function saveScheduleSlot(e) {
    ...
    const res  = await fetch('../php/api/admin/save_section_schedule.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify(payload) });
    const data = await res.json();
...
async function deleteScheduleSlot(id) {
    ...
    const res  = await fetch('../php/api/admin/delete_section_schedule.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({schedule_id:id}) });
    const data = await res.json();
...
<nav class="mobile-bottom-nav">
  ...
  <a href="sections.php" class="mobile-nav-item active"><span class="mobile-nav-icon">📁</span>Sections</a>
