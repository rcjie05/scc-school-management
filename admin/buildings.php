...
async function loadBuildings() {
    const res  = await fetch('../php/api/admin/get_buildings.php');
...
async function saveBuilding() {
    ...
    const res    = await fetch('../php/api/admin/save_building.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify(payload) });
...
async function deleteBuilding(id, name) {
    ...
    const res    = await fetch('../php/api/admin/delete_building.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({building_id:id}) });
    const result = await res.json();
...
async function loadRooms() {
    ...
    const url = '../php/api/admin/get_rooms.php' + (bid ? `?building_id=${bid}` : '');
...
async function saveRoom() {
    ...
    const res    = await fetch('../php/api/admin/save_room.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify(payload) });
    const result = await res.json();
    if (result.success) {
        ...
        if (imageFile && savedRoomId) {
            ...
            const imgRes = await fetch('../php/api/admin/upload_room_image.php', { method:'POST', body:fd });
...
async function deleteRoom(id, name) {
    ...
    const res    = await fetch('../php/api/admin/delete_room.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({room_id:id}) });
    const result = await res.json();
    if (result.success) { loadBuildings(); loadRooms(); }
    else { alert('Error: ' + result.message); }
}
