...
<body>
    ...
    <script>
        ...
        async function loadAnnouncements() {
            ...
            try {
                const response = await fetch(`../php/api/teacher/get_announcements.php${params}`);
...
<nav class="mobile-bottom-nav">
  ...
  <a href="announcements.php" class="mobile-nav-item active"><span class="mobile-nav-icon">📢</span>News</a>
