...
async function loadCourses() {
    ...
    try {
        const res  = await fetch(`../php/api/admin/get_courses.php${params}`);
...
async function saveCourse(e) {
    ...
    try {
        const res    = await fetch('../php/api/admin/save_course.php', {
...
async function deleteCourse(id, name) {
    ...
    try {
        const res    = await fetch('../php/api/admin/delete_course.php', {
...
<nav class="mobile-bottom-nav">
  ...
  <a href="courses.php" class="mobile-nav-item active"><span class="mobile-nav-icon">🎓</span>Courses</a>
