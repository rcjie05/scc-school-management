...
<body>
    ...
    <script>
        ...
        async function loadAnnouncements() {
            ...
            const response = await fetch(`../php/api/registrar/get_announcements.php${params}`);
        ...
        async function deleteAttachment(attachmentId) {
            ...
            const response = await fetch('../php/api/registrar/delete_announcement_attachment.php', {
                method: 'POST',
        ...
        async function saveAnnouncement(e) {
            ...
            const response = await fetch('../php/api/registrar/save_announcement.php', { method: 'POST', body: formData });
            const result = await response.json();
        ...
        async function deleteAnnouncement(id, title) {
            ...
            const response = await fetch('../php/api/registrar/delete_announcement.php', {
