...
<head>
    ...
    <title>Registrar Dashboard - Saint Cecilia College</title>
...
<?php endif; ?></div>
    ...
    <script>
        ...
        async function loadDashboardData() {
            try {
                const response = await fetch('../php/api/registrar/get_dashboard_data.php');
        ...
        async function reviewApplication(applicationId) {
            ...
            try {
                const response = await fetch(`../php/api/registrar/get_application.php?id=${applicationId}`);
                const data = await response.json();
        ...
        async function approveApplication() {
            ...
            try {
                const response = await fetch('../php/api/registrar/approve_application.php', {
                    method: 'POST',
        ...
        async function rejectApplication() {
            ...
            try {
                const response = await fetch('../php/api/registrar/reject_application.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ 
