...
<head>
    ...
    <link rel="apple-touch-icon" href="../images/logo2.jpg">
    <title>Leave Requests - Saint Cecilia College</title>
...
async function loadLeaves() {
    ...
    const res  = await fetch(`../php/api/hr/get_leave_requests.php?year=${year}`);
...
async function reviewLeave(action) {
    ...
    const res  = await fetch('../php/api/hr/review_leave.php', {
...
<nav class="mobile-bottom-nav">
  ...
  <a href="leaves.php" class="mobile-nav-item active"><span class="mobile-nav-icon">📅</span>Leaves</a>
