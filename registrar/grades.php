...
<body>
    ...
    <script>
        ...
        async function loadSubmissions(status) {
            ...
            const url = '../php/api/registrar/get_grade_submissions.php' + (status ? '?status=' + status : '');
        ...
        function buildSubmissionCard(sub) {
            ...
            <div class="sub-card" id="sub-${sub.id}">
                ...
                ${(sub.file_path || sub.has_file_data)
                    ? '<a class="btn-download-file" href="../php/api/registrar/download_grade_sheet.php?id=' + sub.id + '" download>📥 Download Grade Sheet (Excel)</a>'
        ...
        async function reviewSubmission(id, action) {
            ...
            try {
                const r = await fetch('../php/api/registrar/review_grade_submission.php', {
                    method: 'POST',
        ...
        async function loadGrades() {
            ...
            try {
                const r = await fetch('../php/api/registrar/get_grades.php?' + params);
                const d = await r.json();
...
<nav class="mobile-bottom-nav">
  ...
  <a href="grades.php" class="mobile-nav-item active"><span class="mobile-nav-icon">🎓</span>Grades</a>
