...
async function loadMyLeaves() {
    const year = <?= date('Y') ?>;
    const res  = await fetch(`../php/api/hr/get_my_leaves.php?year=${year}`);
...
async function submitLeave() {
    ...
    const res  = await fetch('../php/api/hr/submit_leave.php', {
...
async function cancelLeave(id) {
    ...
    const res  = await fetch('../php/api/hr/cancel_leave.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify({leave_id:id}) });
    const data = await res.json();
