...
async function run() {
    // Test dashboard API
    try {
        const r = await fetch('../php/api/student/get_dashboard_data.php');
    ...
    // Test theme GET
    try {
        const r = await fetch('../php/api/save_theme.php', { credentials: 'same-origin' });
        const ct = r.headers.get('content-type');
    ...
    // Test theme POST
    try {
        const r = await fetch('../php/api/save_theme.php', {
            method: 'POST',
