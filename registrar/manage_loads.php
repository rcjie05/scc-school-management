...
async function boot() {
    try {
        const [sr, secR, subR] = await Promise.all([
            fetch('../php/api/registrar/get_students.php'),
            fetch('../php/api/registrar/get_sections.php?status=active'),
            fetch('../php/api/registrar/get_subjects.php')
        ]);
        ...
        let courseNames = [];
        try {
            const cr = await fetch('../php/api/registrar/get_courses.php');
...
async function selectStudent(id) {
    ...
    try {
        const res  = await fetch('../php/api/registrar/get_student_load.php?student_id=' + id);
...
async function assignSection() {
    ...
    try {
        const res  = await fetch('../php/api/registrar/assign_section_load.php', {
            method: 'POST',
        ...
        if (data.success) {
            ...
            const sres = await fetch('../php/api/registrar/get_students.php');
...
async function addSingleSubject() {
    ...
    try {
        const res  = await fetch('../php/api/registrar/add_subject_to_load.php', {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
...
async function removeSubject(subjectId) {
    ...
    try {
        const res  = await fetch('../php/api/registrar/remove_subject_from_load.php', {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
...
async function finalizeLoad() {
    ...
    try {
        const res  = await fetch('../php/api/registrar/finalize_load.php', {
            method: 'POST',
            headers: {'Content-Type': 'application/json'},
...
async function refreshStudentLoad() {
    try {
        const res  = await fetch('../php/api/registrar/get_student_load.php?student_id=' + selectedId);
        const data = await res.json();
        currentLoad    = data.load    || [];
        currentSection = data.section || null;
...
<nav class="mobile-bottom-nav">
  ...
  <a href="manage_loads.php" class="mobile-nav-item active"><span class="mobile-nav-icon">📚</span>Loads</a>
