...
async function loadBin() {
    try {
        const res  = await fetch('../php/api/admin/get_recycle_bin.php');
...
async function restoreItem(item) {
    ...
    try {
        const res    = await fetch('../php/api/admin/restore_recycle_item.php', {
...
async function deleteForever(item) {
    ...
    try {
        const res    = await fetch('../php/api/admin/permanent_delete_recycle_item.php', {
            method: 'POST', headers: {'Content-Type':'application/json'},
