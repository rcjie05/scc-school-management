...
async function loadEmployees() {
    const res  = await fetch('../php/api/hr/get_employees.php');
...
async function saveEmployee() {
    ...
    const res  = await fetch('../php/api/hr/save_employee.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify(payload) });
    const data = await res.json();
    if (data.success) {
        alert(data.message);
        closeModal();
...
<nav class="mobile-bottom-nav">
  ...
  <a href="employees.php" class="mobile-nav-item active"><span class="mobile-nav-icon">👤</span>Employees</a>
