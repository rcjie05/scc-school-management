...
<head>
    ...
    <title>Payroll - Saint Cecilia College</title>
...
async function loadPayroll() {
    ...
    const res  = await fetch(`../php/api/hr/get_payroll.php?month=${month}&role=${role}`);
...
function showPayslip(id) {
    ...
    const payslipHtml = has ? `
        <div class="slip-header">
            <div class="slip-school">Saint Cecilia College</div>
...
async function savePayroll() {
    ...
    const res  = await fetch('../php/api/hr/save_payroll.php', {
        method: 'POST',
