...
async function loadAnnouncements() {
    ...
    try {
        const res  = await fetch('../php/api/hr/get_announcements_manage.php' + params);
...
async function saveAnnouncement(e) {
    ...
    try {
        const res  = await fetch('../php/api/hr/save_announcement.php', { method:'POST', body:formData });
        const data = await res.json();
...
async function deleteAnnouncement(id, title) {
    ...
    const res  = await fetch('../php/api/hr/delete_announcement.php', {
