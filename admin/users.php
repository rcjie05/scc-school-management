...
async function loadUsers() {
    ...
    try {
        const res  = await fetch(`../php/api/admin/get_users.php?${params}`);
        const data = await res.json();
...
async function loadArchivedUsers() {
    ...
    try {
        const res  = await fetch(`../php/api/admin/get_archived_users.php?${params}`);
        const data = await res.json();
...
async function archiveUser(userId, userName) {
    ...
    try {
        const res    = await fetch('../php/api/admin/archive_user.php', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({user_id: userId}) });
...
async function restoreUser(userId, userName) {
    ...
    try {
        const res    = await fetch('../php/api/admin/restore_user.php', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({user_id: userId}) });
        const result = await res.json();
...
async function permanentlyDelete(userId, userName) {
    ...
    try {
        const res    = await fetch('../php/api/admin/delete_user.php', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({user_id: userId}) });
        const result = await res.json();
        if (result.success) { showToast(result.message); loadArchivedUsers(); }
        else showToast(result.message, 'error');
...
async function activateUser(userId, userName) {
    ...
    try {
        const res    = await fetch('../php/api/admin/toggle_user_status.php', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({user_id: userId, status: 'active'}) });
        const result = await res.json();
        if (result.success) { showToast(result.message); loadUsers(); }
        else showToast(result.message, 'error');
...
async function saveUser(e) {
    ...
    const url = userId ? '../php/api/admin/update_user.php' : '../php/api/admin/add_user.php';
    try {
...
async function confirmSuspension(e) {
    ...
    try {
        const res    = await fetch('../php/api/admin/toggle_user_status.php', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify(data) });
        const result = await res.json();
...
<nav class="mobile-bottom-nav">
  ...
  <a href="users.php" class="mobile-nav-item active"><span class="mobile-nav-icon">👥</span>Users</a>
