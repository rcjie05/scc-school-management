...
<head>
    ...
    <link rel="apple-touch-icon" href="../images/logo2.jpg">
    <title>Recruitment & Onboarding - Saint Cecilia College</title>
...
async function loadJobs() {
    const res  = await fetch('../php/api/hr/get_jobs.php');
...
async function loadApplicants() {
    const res  = await fetch('../php/api/hr/get_applicants.php');
    const data = await res.json();
    if (!data.success) return;
...
async function saveJob() {
    ...
    const res  = await fetch('../php/api/hr/save_job.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify(payload) });
    const data = await res.json();
    if (data.success) {
...
async function saveApplicant() {
    ...
    const res  = await fetch('../php/api/hr/save_applicant.php', { method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify(payload) });
    const data = await res.json();
    if (data.success) {
...
async function onboardApplicant() {
    ...
    const res  = await fetch('../php/api/hr/onboard_applicant.php', {
