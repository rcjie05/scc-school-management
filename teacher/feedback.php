...
async function submitFeedback() {
    ...
    try {
        const res = await fetch('../php/api/teacher/submit_feedback.php', {
...
async function sendReply(id, btn) {
    ...
    try {
        const res = await fetch('../php/api/teacher/reply_feedback.php', {
            method: 'POST', headers: { 'Content-Type': 'application/json' },
...
async function loadMyFeedback() {
    ...
    try {
        const res = await fetch('../php/api/teacher/get_my_feedback.php');
        const data = await res.json();
