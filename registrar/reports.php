...
function generateReport(type) {
    ...
    var urls = {
        enrollment:   '../php/api/registrar/get_enrollment_report.php',
        grades:       '../php/api/registrar/get_grades_report.php',
        applications: '../php/api/registrar/get_applications_report.php'
    };
