...
<body>
    ...
    <script>
        ...
        async function loadApplications() {
            const response = await fetch('../php/api/registrar/get_all_applications.php');
        ...
        async function reviewApplication(id) {
            ...
            const res  = await fetch('../php/api/registrar/get_application.php?id=' + id);
        ...
        async function approveApplication() {
            ...
            const res  = await fetch('../php/api/registrar/approve_application.php', {
        ...
        async function confirmReject() {
            ...
            const res  = await fetch('../php/api/registrar/reject_application.php', {
                method: 'POST', headers: {'Content-Type': 'application/json'},
...
<nav class="mobile-bottom-nav">
  ...
  <a href="applications.php" class="mobile-nav-item active"><span class="mobile-nav-icon">📋</span>Apps</a>
