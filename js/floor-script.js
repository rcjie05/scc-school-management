...
// Pages live at <root>/[role]/floorplan.php -> use ../php/api/routes.php
// Legacy page at <root>/php/floorplan.php   -> use api/routes.php
function getRoutesApiPath() {
    ...
    return lastSegment === 'php' ? 'api/routes.php' : '../php/api/routes.php';
}
