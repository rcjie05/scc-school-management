...
<body>
    ...
    <script>
        ...
        async function loadAnnouncements() {
            ...
            try {
                const response = await fetch(`../php/api/student/get_announcements.php${params}`);
    ...
    async function loadDynamic() {
        ...
        try {
            const [gradesRes, subjectsRes, announcementsRes] = await Promise.allSettled([
                fetch('../php/api/student/get_grades.php').then(r => r.json()),
                fetch('../php/api/student/get_study_load.php').then(r => r.json()),
                fetch('../php/api/student/get_announcements.php').then(r => r.json()),
            ]);
