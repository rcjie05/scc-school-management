...
<body>
    ...
    <script>
        ...
        async function loadClasses() {
            try {
                const res  = await fetch('../php/api/teacher/get_classes.php');
        ...
        async function saveGrade(classIdx, studentUserId, subjectId, semester, schoolYear) {
            ...
            try {
                ...
                const r = await fetch('../php/api/teacher/submit_grades.php', {
                    method: 'POST',
        ...
        async function checkSubmissionStatuses() {
            for (let i = 0; i < allClassesData.length; i++) {
                ...
                try {
                    const r = await fetch('../php/api/teacher/submit_grade_sheet.php?subject_id=' + cls.subject_id + '&section_id=' + cls.section_id);
                    const d = await r.json();
        ...
        async function confirmSubmit() {
            ...
            try {
                ...
                const r = await fetch('../php/api/teacher/submit_grade_sheet.php', {
                    method: 'POST',
                    credentials: 'same-origin',
                    body: form
                });
...
<nav class="mobile-bottom-nav">
  ...
  <a href="classes.php" class="mobile-nav-item active"><span class="mobile-nav-icon">📚</span>Classes</a>
