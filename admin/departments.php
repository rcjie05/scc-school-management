...
<body>
    ...
    <script>
        async function loadDepts() {
            const response = await fetch('../php/api/admin/get_departments.php');
        ...
        async function saveDept(e) {
            ...
            const response = await fetch('../php/api/admin/save_department.php', {
        ...
        async function deleteDept(id, name) {
            ...
            const response = await fetch('../php/api/admin/delete_department.php', {
